<div class="p-6">
    <div class="w-full space-y-12">
        ...
        <div class="space-y-6">
            <h3 class="text-xl font-bold text-zinc-900 dark:text-white">Preguntas frecuentes</h3>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                @foreach([
                    'Mi pedido esta tardando, que hago?',
                    'Como cambio la direccion de entrega?',
                    'Como solicitar un reembolso?',
                    'No puedo pagar, que opciones tengo?',
                    'Donde veo el estado de mi pedido?',
                    'Como contactar al restaurante?'
                ] as $faq)
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 flex flex-col items-center text-center space-y-4 shadow-sm">
                    <div class="text-sm font-bold text-zinc-900 dark:text-white">clientes@comfortfood.com</div>
                    <p class="text-sm text-zinc-500">Escribenos y te respondemos en menos de 24 h.</p>
                    <flux:button variant="outline" class="w-full mt-4 !rounded-xl">Enviar mensaje</flux:button>
                </div>

                <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 flex flex-col items-center text-center space-y-4 shadow-sm">
                    <div class="text-sm font-bold text-zinc-900 dark:text-white">Chat de ayuda</div>
                    <p class="text-sm text-zinc-500">Atencion rapida para pedidos en curso.</p>
                    <flux:button variant="outline" class="w-full mt-4 !rounded-xl">Iniciar chat</flux:button>
                </div>

                <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 flex flex-col items-center text-center space-y-4 shadow-sm">
                    <div class="text-sm font-bold text-zinc-900 dark:text-white">957 60 10 10</div>
