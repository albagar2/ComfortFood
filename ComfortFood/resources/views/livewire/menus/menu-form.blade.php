        ...
        <form wire:submit="save" x-data="{
            ...
            <div class="flex flex-col md:flex-row gap-12">
                ...
                <div class="flex-1 space-y-5">
                    <div class="space-y-1">
                        <label class="text-sm font-medium text-zinc-700 ml-1">Nombre del menú:</label>
                    ...
                    <div class="space-y-1">
                        <label class="text-sm font-medium text-zinc-700 ml-1">Plato Principal:</label>
                    ...
                    <div class="space-y-1">
                        <label class="text-sm font-medium text-zinc-700 ml-1">Segundo Plato:</label>
                    ...
                    <div class="space-y-1">
                        <label class="text-sm font-medium text-zinc-700 ml-1">Postre:</label>
                        <input type="text" wire:model="postre" placeholder="Añadir postre"
                            class="w-full px-4 py-2.5 border border-zinc-200 rounded-full text-sm placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-300" />
                    </div>
                    <div class="space-y-1">
                        <label class="text-sm font-medium text-zinc-700 ml-1">Bebida:</label>
