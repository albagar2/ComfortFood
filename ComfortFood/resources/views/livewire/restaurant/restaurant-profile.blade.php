        ...
        <div wire:key="flash-container">
            @if(session()->has('success'))
                <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)" x-show="show"
                    ...
                    <div class="bg-white dark:bg-zinc-900 p-6 rounded-3xl shadow-2xl max-w-sm w-full text-center space-y-4 border border-zinc-100 dark:border-zinc-800">
                        <div class="size-12 bg-green-100 dark:bg-green-900/30 text-green-600 rounded-2xl flex items-center justify-center mx-auto">
            ...
            @if(session()->has('error'))
                <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)" x-show="show"
                    ...
                    x-transition:leave-end="opacity-0 scale-90"
                     class="fixed inset-0 z-50 flex items-center justify-center px-4 bg-black/20 backdrop-blur-sm">
                    <div class="bg-white dark:bg-zinc-900 p-6 rounded-3xl shadow-2xl max-w-sm w-full text-center space-y-4 border border-zinc-100 dark:border-zinc-800">
                         <div class="size-12 bg-red-100 dark:bg-red-900/30 text-red-600 rounded-2xl flex items-center justify-center mx-auto">
                ...
                @if(auth()->check() && auth()->user()->id_usuario === $restaurante->id_usuario)
                    ...
                    <div class="absolute top-6 right-6 z-10" 
                        ...
                        <label for="restaurant-photo" class="cursor-pointer group/upload">
                            ...
                            <input type="file" id="restaurant-photo" x-on:change="handleFileSelect" class="hidden" accept="image/*">
                        </label>
                    </div>
                @endif
                ...
                <div class="bg-zinc-900 dark:bg-white rounded-3xl p-6 text-white dark:text-zinc-900 space-y-4">
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-bold">15-20 min</span>
                        </div>
                        <div class="flex justify-between text-sm">
