<x-layouts::auth>
    <div class="flex w-full h-screen overflow-hidden bg-white dark:bg-[#121212]">
        ...
        <div class="w-full md:w-1/2 h-full overflow-y-auto flex flex-col justify-center items-center px-8 md:px-16 lg:px-24 py-12">
            <div class="w-full max-w-[450px] flex flex-col gap-4">
             ...
             <img src="{{ asset('images/logo.png') }}" alt="ComfortFood" class="h-16 w-auto mx-auto mb-2">
                ...
                <form method="POST" action="{{ route('login.store') }}" class="flex flex-col gap-6">
                    ...
                    <flux:checkbox name="remember" :label="__('Recu├®rdame')" :checked="old('remember')" />
