<section class="w-full">
    ...
    <x-settings.layout :heading="__('Actualiza tu contraseña')" :subheading="__('Asegúrate de que tu cuenta esté utilizando una contraseña larga y aleatoria para mantenerla segura')">
