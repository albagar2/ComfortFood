    ...
    <div class="p-6">
        ...
        <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 overflow-hidden max-w-4xl mx-auto">
            <div class="flex items-center justify-between px-8 py-6 border-b border-zinc-100 dark:border-zinc-800">
                 ...
                 @else
                    <span class="bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400 text-xs font-medium px-3 py-1 rounded-full">Inactivo</span>
                 @endif
                 
                 <div class="text-center flex-1">
                     <h2 class="text-lg font-bold text-zinc-900 dark:text-white">{{ $user->nombre_completo }}</h2>
                 </div>
                 <a href="{{ route('admin.users.edit', $user) }}" class="bg-blue-600 text-white px-4 py-1.5 rounded-md text-sm hover:bg-blue-700 flex items-center gap-2">
            ...
            <div class="p-8 space-y-6">
                @if($user->isRestaurante())
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 border-b border-zinc-50 dark:border-zinc-800 pb-4">
                        ...
                        <div class="md:col-span-2 text-sm text-zinc-900 dark:text-zinc-300">{{ $user->nombre_completo }}</div>
                    </div>
                @else
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 border-b border-zinc-50 dark:border-zinc-800 pb-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 border-b border-zinc-50 dark:border-zinc-800 pb-4">
                    <div class="text-sm font-medium {{ $user->isRestaurante() ? 'text-purple-600 dark:text-purple-400' : 'text-blue-500' }}">{{ $user->isRestaurante() ? 'NIF:' : 'DNI:' }}</div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 border-b border-zinc-50 dark:border-zinc-800 pb-4">
                    <div class="text-sm font-medium {{ $user->isRestaurante() ? 'text-purple-600 dark:text-purple-400' : 'text-blue-500' }}">Dirección:</div>
                    <div class="md:col-span-2 text-sm text-zinc-900 dark:text-zinc-300">
                        @if($user->isRestaurante())
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 border-b border-zinc-50 dark:border-zinc-800 pb-4">
                    <div class="text-sm font-medium {{ $user->isRestaurante() ? 'text-purple-600 dark:text-purple-400' : 'text-blue-500' }}">Teléfono:</div>
                    <div class="md:col-span-2 text-sm text-zinc-900 dark:text-zinc-300">
                        @if($user->isRestaurante())
                ...
                @if($user->isRestaurante())
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 border-b border-zinc-50 dark:border-zinc-800 pb-4">
                        ...
                        <div class="md:col-span-2 text-sm text-zinc-900 dark:text-zinc-300">{{ $user->restaurante->tipo_cocina ?? '-' }}</div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 border-b border-zinc-50 dark:border-zinc-800 pb-4">
                ...
                @endif
                 ...
                 <div class="grid grid-cols-1 md:grid-cols-3 gap-4 border-b border-zinc-50 dark:border-zinc-800 pb-4">
                    <div class="text-sm font-medium {{ $user->isRestaurante() ? 'text-purple-600 dark:text-purple-400' : 'text-blue-500' }}">Tipo de usuario:</div>
                    <div class="md:col-span-2 text-sm text-zinc-900 dark:text-zinc-300">{{ $user->rol->nombre_rol }}</div>
                </div>
                 <div class="grid grid-cols-1 md:grid-cols-3 gap-4 border-b border-zinc-50 dark:border-zinc-800 pb-4">
                    <div class="text-sm font-medium {{ $user->isRestaurante() ? 'text-purple-600 dark:text-purple-400' : 'text-blue-500' }}">Fecha de registro:</div>
                    <div class="md:col-span-2 text-sm text-zinc-900 dark:text-zinc-300">{{ $user->created_at->format('d-m-Y') }}</div>
                </div>
                 <div class="grid grid-cols-1 md:grid-cols-3 gap-4 border-b border-zinc-50 dark:border-zinc-800 pb-4">
                    <div class="text-sm font-medium {{ $user->isRestaurante() ? 'text-purple-600 dark:text-purple-400' : 'text-blue-500' }}">Email:</div>
                 ...
                 <div class="grid grid-cols-1 md:grid-cols-3 gap-4 pb-4">
                    <div class="text-sm font-medium {{ $user->isRestaurante() ? 'text-purple-600 dark:text-purple-400' : 'text-blue-500' }}">Contraseña:</div>
